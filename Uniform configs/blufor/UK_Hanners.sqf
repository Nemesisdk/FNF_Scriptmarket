...
phx_loadout_uniform = "U_mas_ukl_B_CombatUniform_m2";
phx_loadout_vest = "V_mas_ukl_PlateCarrierLR_tan";
phx_loadout_backpack = "B_mas_ukl_Kitbag_d";
phx_loadout_headgear = "H_mas_ukl_opscore_gog_t";
